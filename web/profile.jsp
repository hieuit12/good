<%-- 
    Document   : profile
    Created on : Oct 27, 2024, 1:09:16 AM
    Author     : Legion 5
--%>
    ...
    <div class="container">
        ...
        <form action="updateprofile" method="post">
            ...
            <div class="profile-pic">
                <img src="https://i.pinimg.com/236x/e7/8c/55/e78c55cf7a363aa5b2a54e07a42eb9ed.jpg" alt="Ảnh đại diện">
            ...
            <div class="section">
                <!--            <div class="section-title">Thông Tin Cá Nhân <span class="edit-btn">Chỉnh sửa</span></div>-->
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" value="${uemail}" readonly>
                </div>
                <div class="form-group">
                    <label for="dob">Date of birth:</label>
                    <input type="date" id="dob" name="dob" value="${undob}">
                </div>
                <div class="form-group">
                    <label>Gender:</label>
                    <div>
                        <input type="radio" id="male" name="gender" value="Male" ${ugender == 'Male' ? 'checked' : ''}>
                        <label for="male">Male</label>
                    </div>
                    <div>
                        <input type="radio" id="female" name="gender" value="Female" ${ugender == 'Female' ? 'checked' : ''}>
            ...
            <!-- Địa chỉ giao hàng -->
            <div class="section">
                <!--            <div class="section-title">Địa Chỉ Giao Hàng <span class="edit-btn">Chỉnh sửa</span></div>-->
                <div class="form-group">
                    <label for="address">Address:</label>
                    <input type="text" id="address" name="address" value="${uaddress}">
                </div>
            </div>

            <!-- Nút lưu thay đổi -->
            <!--        <button class="button">Lưu Thay Đổi</button>-->
            <input type="submit" name="Lưu Thay Đổi" class="button" value = "Save changes" style="background-color: #FFC1C1">
