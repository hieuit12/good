<%-- 
    ...
    Created on : Oct 16, 2024, 10:27:31 PM
    Author     : DELL
--%>
...
<html lang="en">
    ...
    <!-- Mirrored from demo.templatesjungle.com/stylish/single-post.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Oct 2024 14:00:52 GMT -->
    <head>
    ...
    <div class="post-wrap py-2 my-2 py-md-5 my-md-5 overflow-hidden">
        <div class="container">
            <div class="row">
                <main>
                    <div class="row">
                        <article class="post-item">
                            <div class="post-content">
                                <div class="post-meta text-uppercase">
                                    <span class="post-category">Feb 22, 2023 </span> / <span class="meta-date">- Casual</span>
                                </div>
                                <h1 class="post-title">Running shoes for men</h1>
                                <div class="hero-image col-lg-12 mt-5">
                                    <img src="images/single-post-item.jpg" alt="single-post" class="single-image img-fluid">
                                </div>
                                <div class="post-description padding-medium">
                                    ...
                                    <p>Sit suscipit tortor turpis sed fringilla lectus facilisis amet. Ipsum, amet dolor curabitur non
                                        ...
                                        nunc integer sit.</p>
                                    <blockquote class="fs-3">“Sit suscipit tortor turpis sed fringilla lectus facilisis amet. Ipsum, amet
                                        dolor curabitur non aliquet orci urna volutpat. Id aliquam neque, ut vivamus sit imperdiet enim,
                                        lacus, vel.</blockquote>
                                    <p>
                                    ...
                                    <p>Tortor diam dignissim amet, in interdum aliquet. Magnis dictum et eros purus fermentum, massa
                                        ...
                                        mi consequat libero dolor. Porta ut diam lobortis eget leo, lectus. Nunc tempus feugiat massa
                                        laoreet ultrices diam magna quam. Congue auctor auctor luctus neque. Enim lorem ultrices diam donec.
                                        Sed id placerat consectetur faucibus.</p>
                                    <img src="images/post-item6.jpg" alt="post-image" class="float-start py-3 pe-3 img-fluid">
                                    <p>
                                    ...
                                    <p>Tortor diam dignissim amet, in interdum aliquet. Magnis dictum et eros purus fermentum, massa
                                        ...
                                        nec, rutrum a diam lacus, nunc integer etiam. Mattis pulvinar non viverra donec pellentesque. Odio
                                        mi consequat libero dolor. Porta ut diam lobortis eget leo, lectus.</p>
                                    <p>Praesent pharetra malesuada id pulvinar amet. Consequat potenti mollis massa iaculis et, dolor,
                                        eget lectus. Aliquam pellentesque molestie felis fames sed eget non euismod eget. Et eget
                                        ullamcorper urna, elit ac diam tellus viverra lacus.</p>
                                    <p>Tortor diam dignissim amet, in interdum aliquet. Magnis dictum et eros purus fermentum, massa
                                        ullamcorper sit sollicitudin. Nascetur libero elementum adipiscing mauris maecenas et magna. Etiam
                                        nec, rutrum a diam lacus, nunc integer etiam. Mattis pulvinar non viverra donec pellentesque. Odio
                                    ...
                                    <div class="post-bottom-link d-flex justify-content-between">
                                        ...
                                        <div class="social-links d-flex">
                                            ...
                                            <ul class="d-flex list-unstyled">
                                                <li>
                                                    <a href="#">
                                                        <svg class="facebook me-2" width="16" height="16">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <svg class="instagram me-2" width="16" height="16">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <svg class="youtube" width="16" height="16">
                                ...
                                <div id="single-post-navigation" class="mb-5">
                                    <div class="post-navigation d-flex flex-wrap align-items-center justify-content-between">
                                        <a itemprop="url" class="post-prev d-flex align-items-center" href="#">
                                            <svg class="long-arrow-left" width="20" height="20">
                                            <use xlink:href="#long-arrow-left"></use>
                                            </svg>
                                            <span class="page-nav-title fs-4">Stylish shoes for men</span>
                                        </a>
                                        <a itemprop="url" class="post-next d-flex align-items-center" href="#">
                                            <span class="page-nav-title fs-4">Casual shoes for men</span>
                                            <svg class="long-arrow-right" width="20" height="20">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                            ...
                                            <div class="comment-list padding-small">
                                                <article class="comment-item d-flex flex-wrap mb-3">
                                                    <div class="col-lg-1 col-sm-3 me-4 mb-3">
                                                        <img src="images/commentor-item1.jpg" alt="default" class="commentor-image">
                                                    </div>
                                                    <div class="col-lg-10 col-sm-9 author-wrap">
                                                        <div class="author-post">
                                                            ...
                                                            <div class="comments-reply">
                                                                <a href="#" class="btn btn-normal">Reply Now</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </article>
                                                <article class="comment-item d-flex child-comments flex-wrap ps-5 mb-3">
                                                    <div class="col-lg-1 col-sm-3 me-4 mb-3">
                                                        <img src="images/commentor-item2.jpg" alt="default" class="commentor-image">
                                                    </div>
                                                    <div class="col-lg-10 col-sm-9 author-wrap">
                                                        <div class="author-post">
                                                            <div class="comment-meta d-flex">
                                                ...
                                                <article class="comment-item d-flex flex-wrap">
                                                    <div class="col-lg-1 col-sm-3 me-4 mb-3">
                                                        <img src="images/commentor-item3.jpg" alt="default" class="commentor-image">
                                                    </div>
                                                    <div class="col-lg-10 col-sm-9 author-wrap">
                                                        <div class="author-post">
                                                            <div class="comment-meta d-flex">
                                        ...
                                        <div class="comment-respond mt-3">
                                            <h2 class="fs-4 fw-bold text-dark">Leave a Comment</h2>
                                            <form method="post" class="form-group padding-small">
                                                <p>Your email address will not be published. Required fields are marked *</p>
                                                <div class="row">
                                                    <div class="col-lg-12 mb-3">
                                                        <textarea class="u-full-width ps-3 pt-3 border" id="comment" name="comment"
                                                                  placeholder="Write your comment here *"></textarea>
                                                    </div>
                                                    <div class="col-lg-6 mb-3">
                                                        <input class="u-full-width ps-3 border" type="text" name="author" id="author"
                                                               placeholder="Write your full name here *">
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <input class="u-full-width ps-3 border" type="email" name="email" id="email"
                                                               placeholder="Write your e-mail address *">
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <label class="d-flex align-items-center">
                                                            <input type="checkbox" class="checked-box me-2 border">
                                                            <span class="label-body">Save my name, email, and website in this browser for the next
                                                                time.</span>
                                                        </label>
                                                    </div>
                                                    <div class="col-lg-12 mt-5">
                                                        <button class="btn btn-medium btn-black text-uppercase" type="submit">Post Comment </button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
        ...
        <div class="container-lg">
            <div class="row">
                <div class="display-header text-center">
                    <h2 class="display-7">Related Posts</h2>
                </div>
...
<!-- Mirrored from demo.templatesjungle.com/stylish/single-post.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Oct 2024 14:00:53 GMT -->
</html>