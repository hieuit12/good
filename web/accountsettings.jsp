<%-- 
    Document   : checkout
    Created on : Oct 24, 2024, 6:57:23 PM
    Author     : Legion 5
--%>
                    ...
                    <div class="shopping-cart">
                        <div class="shopping-cart-content">
                            ...
                            <div class="modal-footer my-4 justify-content-center">
                                ...
                                <a href="checkout.jsp" class="btn btn-outline-gray hvr-sweep-to-right dark-sweep">Add Order</a> 
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <form action="emailServlet" method="post">
        ...
        <div class="section">
            ...
            <div class="form-group">
                ...
                <input type="text" value="${account.username}" name="name" placeholder="Nhập họ và tên của bạn" readonly>
            </div>
            <div class="form-group">
                <label for="email">Email:</label>
                <input type="email" value="${account.email}" name="email" placeholder="Nhập địa chỉ email của bạn">
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="form-group">
                ...
                <div style="position: relative;">
                    <input type="password" id="current-password" value="${account.password}" name="current-password" placeholder="Nhập mật khẩu hiện tại của bạn" style="width: 100%; padding-right: 40px;" readonly>
                    <button type="button" onclick="togglePasswordVisibility()" id="toggle-password" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer;">
                        👁️
                    </button>
                </div>
                <a href="changepassword.jsp">Change password?</a>

                <input type="submit" class="button" value="Save Changes" style="background-color: #FFC1C1">
            </div>
        </div>
    ...
    <script>
                        function togglePasswordVisibility() {
                            ...
                            if (passwordField.type === "password") {
                                ...
                                toggleButton.textContent = "🙈"; // Đổi biểu tượng thành "ẩn"
                            } else {
                                passwordField.type = "password";
                                toggleButton.textContent = "👁️"; // Đổi biểu tượng thành "hiện"
                            }
                        }
    </script>
</div>
