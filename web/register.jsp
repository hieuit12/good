                                ...
                                <div class="col-lg-12 mx-auto">
                                    <form action="signup" id="login-form">
                                        ...
                                        <div class="modal-footer mt-4 d-flex justify-content-center">
                                            ...
                                            <input type="submit" value="Sign up" class="btn btn-outline-gray hvr-sweep-to-right dark-sweep">
                                            <!--                                            <a href="home2.jsp" class="btn btn-red hvr-sweep-to-right dark-sweep">Sign Up</a> -->
                                        </div>
                                    </form>
                                </div>
                            </div>
