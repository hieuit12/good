...
<html lang="en">
    ...
    <div class="container mt-5">
            ...
            <tbody>
                <c:forEach var="p" items="${listDetail}">
                    <tr>
                        ...
                        <td>${p.getPrice()}</td>
                        <td>
                            <img src="${p.getImage()}" alt="Product Image" class="img-thumbnail" style="width: 50px; height: 50px;">
                        </td>
                        <td>${p.getDescribe()}</td>
                        <td>${p.getDetailId()}</td>
                        <td>
                            <span class="badge badge-pill ${p.getStatus() == 'Available' ? 'badge-success' : 'badge-secondary'} text-dark">
                                ${p.getStatus()}
                            </span>

                        </td>
                        <td>
                            <a href="updatedetail?oderdetailid=${p.getDetailId()}" class="btn btn-outline-success btn-sm">
                                Thanh Toán
                            </a>
                        </td>
                        <td>
                            <a href="deletedetail?oderdetailid=${p.getDetailId()}" class="btn btn-outline-danger btn-sm"
        ...
        <div class="d-flex justify-content-center mt-4">
            <a href="showlist" class="btn btn-primary btn-lg shadow-sm px-4 py-2 rounded-pill">
