...
<!--------------------------------------------------------------------------------------------------------------------->
    <div class="checkout-container">
        ...
        <div class="checkout-header">
            ...
            <p>This is the first step of your purchase!</p>
        </div>
        ...
        <!-- Steps Progress -->
            ...
            <div class="col-md">
                <div class="payment-section">
                    ...
                    <form action="addorder" method="post" class="payment-form">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="paymentMethod" class="form-select" name="payid" required>
                        ...
                        <button type="submit" class="btn btn-checkout w-100">Confirm and Pay</button>
                    </form>
                </div>
            </div>
