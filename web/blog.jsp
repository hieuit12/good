<%-- 
    Document   : blog
    Created on : Oct 16, 2024, 10:11:10 PM
    Author     : DELL
--%>
...
<html lang="en">
    ...
    <!-- Mirrored from demo.templatesjungle.com/stylish/blog.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Oct 2024 14:00:48 GMT -->
    <head>
    ...
    <div class="search-box bg-dark position-relative">
        <div class="search-wrap">
            ...
            <form id="search-form" class="text-lg-center text-md-left pt-3" action="https://demo.templatesjungle.com/stylish/home2.jsp" method="get">
                    ...
                    <div class="shopping-cart">
                        <div class="shopping-cart-content">
                            ...
                            <div class="modal-footer my-4 justify-content-center">
                                <button type="button" class="btn btn-red hvr-sweep-to-right dark-sweep">Add Order</button>
                                <button type="button"
    ...
    <section class="post-list py-2 my-2 py-md-5 my-md-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-md-12">
                    <div class="post-item d-flex flex-wrap align-items-center padding-small">
                        ...
                        <div class="col-lg-6 ms-5">
                            <div class="post-meta text-uppercase fs-6 d-flex">
                                <a href="#" title="fashion">Fashion</a> &nbsp;&nbsp;•&nbsp;&nbsp; 
                                <span class="post-meta">15th April 2023</span>
                            </div>
                            <h3 class="post-title my-3"><a href="single-post.jsp">Running Shoes For Men</a></h3>
                            <p>Lorem, ipsum dolor sit amet consectetur adipisicing m blanditiis soluta repellat exercitationem temporibus deleniti ea dolorum quia, qui eligendi molestiae unde molestias facere!</p>
                            <a href="single-post.jsp" class="text-hover d-inline-block">Read More</a>
                        </div>
                    </div>
                    <div class="post-item d-flex flex-wrap align-items-center padding-small">
                        <div class="col-lg-5">
                ...
                <aside class="col-lg-3 col-md-12">
                    <div class="sidebar">
                        <div class="widget-menu mb-5">
                            <div class="widget-search-bar position-relative">
                                <form role="search" method="get" class="d-flex">
                                    <input class="search-field rounded-2" placeholder="Search" type="search">
                        ...
                        <div class="widget blogger">
                            <div class="textwidget mb-5">
                                <div class="post-sidebar">
                                    <img src="images/author-item.jpg" alt="blogger" class="img-fluid">
                                    <div class="content-post text-center px-3 pt-5">
                                        <h4 class="author-name">Zhang Wei</h4>
                                        <span class="job">Photographer and Blogger</span>
                                        <p>Nullam vulputate risus vel est porttitor eu malesuada neque pulvinar. Nullam vulputate risus vel
                                            est porttitor eu malesuada neque pulvinar.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="social-widget text-center py-5 bg-gray">
                            ...
                            <div class="sidebar-post-item">
                                <div class="row g-3 mb-3">
                                    <div class="col-md-4">
                                        <div class="image-holder">
                                            <a href="#">
                                                <img src="images/post-thumb-image1.jpg" alt="blog" class="img-fluid">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="sidebar-post-content">
                                            <div class="post-meta">
                                                <span class="meta-date text-uppercase">jul 11, 2023</span>
                                            </div>
                                            <h6 class="post-title">
                                                <a href="single-post.jsp">Shoes is the first thing to notice</a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 mb-3">
                                    <div class="col-md-4">
                                        <div class="image-holder">
                                            <a href="#">
                                                <img src="images/post-thumb-image2.jpg" alt="blog" class="img-fluid">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                ...
                                <div class="row g-3 mb-3">
                                    <div class="col-md-4">
                                        <div class="image-holder">
                                            <a href="#">
                                                <img src="images/post-thumb-image3.jpg" alt="blog" class="img-fluid">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                        ...
                        <div class="widget widget-tags mt-5">
                            <h5 class="widget-title text-decoration-underline">Tags</h5>
                            <div class="tags-item text-hover d-flex flex-wrap gap-3">
                                <a href="#" class="tag-link">Fashion</a>
                                <a href="#" class="tag-link">Shoes</a>
                                <a href="#" class="tag-link">Trending</a>
                                <a href="#" class="tag-link">Casual</a>
                                <a href="#" class="tag-link">Sports</a>
                                <a href="#" class="tag-link">White</a>
                                <a href="#" class="tag-link">Sneakers</a>
                                <a href="#" class="tag-link">Slippers</a>
                            </div>
                        </div>
                    </div>
                </aside>
...
<!-- Mirrored from demo.templatesjungle.com/stylish/blog.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Oct 2024 14:00:50 GMT -->
</html>