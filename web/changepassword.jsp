    ...
    <head>
        ...
        <style>
            ...
            /*            .human-check {
                        ...
                        .human-check input[type="checkbox"]:checked {
                            background-color: #4CAF50;
                            border-color: #4CAF50;
                        }
            
                        .human-check input[type="checkbox"]:checked::after {
                            content: '';
                            position: absolute;
                            top: 2px;
                            left: 6px;
            ...
            /* Hiệu ứng quét từ trái sang phải (hvr-sweep-to-right) cho thẻ input */
            ...
            <div class="modal-dialog modal-fullscreen-md-down modal-md modal-dialog-centered" role="document">
                <div class="modal-content p-4">
                    <div class="modal-header mx-auto border-0">
                        <h2 class="modal-title fs-3 fw-normal d-block">Change your password</h2>
                    </div>
                    <form action="change" id="login-form">
                        <div class="modal-body">
                            <div class="login-detail">
                                <div class="login-form p-0">
                                    <div class="col-lg-12 mx-auto">
                                        <input type="password" name="password" placeholder="Old-Password" class="mb-3 ps-3 text-input" required> <!--class="ps-3 text-input"-->
                                        <input type="password" name="pass" placeholder="New-Password" class="mb-3 ps-3 text-input" required> <!--class="ps-3 text-input"-->
                                ...
                                <div class="modal-footer mt-4 d-flex justify-content-center">
                                    <a href="home2.jsp" class="btn btn-red hvr-sweep-to-right dark-sweep">Cancel</a> 
                                    <input type="submit" value="Change" class="btn btn-outline-gray hvr-sweep-to-right dark-sweep">
                                </div>
                            </div>
                        </div>
                    </form>
